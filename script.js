...
const p1_score = p1.querySelector('.dice-score');
const p2_score = p2.querySelector('.dice-score');

const p1_current = p1.querySelector('.score');
const p2_current = p2.querySelector('.score');
...
const rollDice = () => {
  ...
  if (randomDice > 1) {
    ...
    activePlayer === 1 
      ? p1_current.innerHTML = current_score 
      : p2_current.innerHTML = current_score
